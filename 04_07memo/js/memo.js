...
window.addEventListener(
    ...
    function () {
        ...
        if (typeof localStorage === "undefined") {
            window.alert("このブラウザは local Storage 機能が使えません");
            return;
        } else {
            viewStorage();
            savelocalStorage();
        ...
        function (e) {
            ...
            if (w_sel === "1") {
                ...
                if (w_confirm === true) {
                    ...
                    viewStorage();
                    let w_msg = "LocalStorageから " + key + " " + value  + " 削除をしました。";
                    window.alert(w_msg);
                    document.getElementById("textKey").value = "";
                    document.getElementById("textMemo").value = "";
                }
...
function allClearLocalStorage() {
    const select = document.getElementById("allClear");
    allClear.addEventListener("click",
        function (e) {
            ...
            if (w_confirm === true) {
                localStorage.clear();
                viewStorage();
                let w_msg = "LocalStorageからのデータをすべて削除しました。";
                window.alert(w_msg);
                document.getElementById("textKey").value = "";
                document.getElementById("textMemo").value = "";
            }
